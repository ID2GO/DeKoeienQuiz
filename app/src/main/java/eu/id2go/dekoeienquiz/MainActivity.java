...
//      Q4
        textInputQ3 = (EditText) findViewById(R.id.text_input);
//      Q4
...
//            points ++;
    ...
    private void checkQuestionOneB(){
        CheckBox checkbox_answerQ1_2 = (CheckBox) findViewById(R.id.checkboxQ1_2);
        hasAnswerQ1_2 = checkbox_answerQ1_2.isChecked();
        if (hasAnswerQ1_2) {
            final_summary.setText(final_summary.getText() + "\n" + "Answer Q1_2: It's time to " +
                    "milk");
            final_summary.setEnabled(true);
//            points ++;
        } else {
    ...
    private void checkQuestionOneC() {
        CheckBox checkbox_answerQ1_3 = (CheckBox) findViewById(R.id.checkboxQ1_3);
        boolean hasAnswerQ1_3 = checkbox_answerQ1_3.isChecked();
        if (hasAnswerQ1_3) {
            final_summary.setText(final_summary.getText() + "\n" + "Answer Q1_3: It's spring time");
            final_summary.setEnabled(true);
              points ++;
        } else {
            final_summary.setEnabled(false);
...
//      here the code checks for exact spelling of the input of the user
        if (edittext.getText().toString().trim().equals("Galloway")) {
            final_summary.setText(final_summary.getText() + "\n" + "Q3: Galloway");
            points ++;
    ...
    private void checkQuestionFourA() {
        CheckBox checkbox_answerQ4_1 = (CheckBox) findViewById(R.id.checkboxQ4_1);
        boolean hasAnswerQ4_1 = checkbox_answerQ4_1.isChecked();
        if (hasAnswerQ4_1) {
            final_summary.setText(final_summary.getText() + "\n" + "Answer Q4_A: Hippopotamus");
            final_summary.setEnabled(true);
//            points ++;
        } else {
            final_summary.setEnabled(false);
    ...
    private void checkQuestionFourB() {
        CheckBox checkbox_answerQ4_2 = (CheckBox) findViewById(R.id.checkboxQ4_2);
...
//            points ++;
    ...
    private void checkQuestionFourC() {
        CheckBox checkbox_answerQ4_3 = (CheckBox) findViewById(R.id.checkboxQ4_3);
